 ...
 */}
                        ...
                        <Autosuggest
                            suggestions={displayedItems}
                            onSuggestionsFetchRequested={({ value }) => {
                                // Update the displayedItems state with filtered suggestions
                                setDisplayedItems(
                                    customerSearchResults
                                        .filter((customer) =>
                                            customer.json.customer_name
                                            ...
                                            customer.json.mobile.toLowerCase().includes(value.toLowerCase())
                                        )
                                        .slice(0, MAX_RESULTS)
                                );
                            }}
                            onSuggestionsClearRequested={() => setDisplayedItems([])}
