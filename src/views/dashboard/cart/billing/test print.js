...
const PayBillsModels = ({
  ...
  console.log('deliveryt data', submittedHomeDeliveryData)
  ...
  const cartSumUp = {
    ...
    deliveryDate: submittedPickUpDateTime?.date,
    deliveryTime: submittedPickUpDateTime?.time,
    receiverName: "",
    receiverMobileNo: "",
    deliveryAddress: "",
                  ...
                  <>
                    <CCol sm={7} xs={7} className="kot-border-b">
                      {item.prod_Customized_status == 1 ? (
                        <>
                          <font size="3" className="font-size-14">
